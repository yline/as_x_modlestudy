...
public class PasswordView extends LinearLayout
{
    ...
    private void initData()
    {
        ...
        mKeyNumberBroadView.setOnDeleteClickListener(new KeyNumberBroadView.onDeleteClickListener()
        {
            ...
            public void onDeleteClick(View view)
            {
                ...
                if (mTempResult.length() > 0)
                {
                    ...
                    // 密文
                    mTempResultBlack = mTempResultBlack.substring(0,
                        mTempResultBlack.length() - mTempResultBlackList.get(mTempResult.length()));
        ...
        mTvSecure.setOnClickListener(new View.OnClickListener()
        {
    ...
    private void initLayoutParams(Context context, View view)
    {
        ...
        android.widget.LinearLayout.LayoutParams localLayoutParams = new android.widget.LinearLayout.LayoutParams(1, 1);
        localLayoutParams.width = (int)(outMetrics.widthPixels);
        localLayoutParams.height = (int)(outMetrics.heightPixels);
        LogFileUtil.v(TAG,
            "localLayoutParams.width = " + localLayoutParams.width + ",localLayoutParams.height = "
