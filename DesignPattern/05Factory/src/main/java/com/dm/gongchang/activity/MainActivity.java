...
import com.design.pattern.factory.R;
...
public class MainActivity extends BaseActivity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		findViewById(R.id.btn_factory_reflact).setOnClickListener(new View.OnClickListener()
		{
			...
			public void onClick(View v)
			{
				com.dm.gongchang.factory.reflact.Factory factoryA = new com.dm.gongchang.factory.reflact.ConcreteFactory();
				com.dm.gongchang.product.Product productA = factoryA.createProduct(ConcreteProductA.class);
				productA.method();

				com.dm.gongchang.factory.reflact.Factory factoryB = new com.dm.gongchang.factory.reflact.ConcreteFactory();
