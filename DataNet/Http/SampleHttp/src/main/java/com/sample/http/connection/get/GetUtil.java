package com.sample.http.connection.get;
...
public class GetUtil
{
	...
	public static void doLocal(String ip, String projectName, String classStr, final GetCallback callback)
	{
	 ...
	 */
	private static void doGetAsyn(final String httpUrl, final GetCallback callback)
	{
	 ...
	 * @param e
	 */
	private static void handleError(final GetCallback callback, final Exception e)
	{
	 ...
	 * @param result
	 */
	private static void handleSuccess(final GetCallback callback, final String result)
	{
		mHandler.post(new Runnable()
		{
