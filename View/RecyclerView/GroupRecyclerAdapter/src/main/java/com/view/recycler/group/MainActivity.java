...
public class MainActivity extends BaseAppCompatActivity {
    ...
    private class EAdapter extends CommonGroupRecyclerAdapter<String, String, Object> {
        ...
        @Override
        protected void onBindViewHolderHead(RecyclerViewHolder viewHolder, List<String> strings, final int positionOfGroup) {
        ...
        @Override
        protected void onBindViewHolderItem(RecyclerViewHolder viewHolder, List<List<String>> itemDoubleList, int positionOfGroup, int positionInGroup) {
