package com.view.textview.keyclear.view;
...
import com.view.textview.keyclear.R;
...
public class ViewKeyClearEditText extends AppCompatEditText implements View.OnFocusChangeListener, TextWatcher {
    ...
    public ViewKeyClearEditText(Context context) {
        this(context, null);
    }

    public ViewKeyClearEditText(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.editTextStyle);
    }

    public ViewKeyClearEditText(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initClearDrawable(Context context) {
        ...
        if (mClearDrawable == null) {
            mClearDrawable = ContextCompat.getDrawable(context, getXKeyClearDrawable());
        }
    ...
    protected int getXKeyClearDrawable() {
        return R.drawable.view_key_clear;
    }
}
