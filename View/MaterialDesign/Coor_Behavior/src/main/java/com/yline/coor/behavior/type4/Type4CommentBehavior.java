 ...
 * 列表Behavior
 */
public class Type4CommentBehavior extends HeaderScrollingViewBehavior {
    private Context mContext;

    public Type4CommentBehavior() {
    }

    public Type4CommentBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
    }
