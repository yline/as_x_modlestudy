...
public class CarouselPagerFragment extends Fragment
{
    ...
    private class ViewPagerAdapter extends PagerAdapter
    {
        ...
        public Object instantiateItem(ViewGroup container, int position)
        {
            ...
            view.setOnClickListener(new View.OnClickListener()
            {
                ...
                {
                    if (getActivity() instanceof CarouselPagerFragment.onPagerClickListener)
                    {
                        ((CarouselPagerFragment.onPagerClickListener)getActivity()).onPagerClicked(v, index);
                    }
                }
            });
    ...
    {
        android.view.ViewGroup.LayoutParams pagerParam = view.getLayoutParams();
