package com.fragment.tab.styleline;

import com.fragment.tab.R;
import com.fragment.tab.activity.MainApplication;
 ...
 */
public class TabLineFragment extends Fragment
{
    ...
    private class tabsChangeClickListener implements View.OnClickListener
    {
        ...
        public void onClick(View v)
        {
            ...
            if (getActivity() instanceof TabLineFragment.OnTabSelectedListener)
            {
                ((TabLineFragment.OnTabSelectedListener)getActivity()).onTabSelected(position);
            }
        }
    }
