...
class SwipeDragHelper {
    ...
    private boolean mAllowLeftFullScreen = false;
     ...
     */
    public static SwipeDragHelper create(ViewGroup forParent, Callback cb) {
        return new SwipeDragHelper(forParent.getContext(), forParent, cb);
    }
     ...
     * @return a new ViewDragHelper instance
     */
    public static SwipeDragHelper create(ViewGroup forParent, float sensitivity, Callback cb) {
        final SwipeDragHelper helper = create(forParent, cb);
     ...
     * @param forParent Parent view to monitor
     */
    private SwipeDragHelper(Context context, ViewGroup forParent, Callback cb) {
        if (forParent == null) {
