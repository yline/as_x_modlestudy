...
import com.viewgroup.swipeback.R;
...
public class SwipeBackLayout extends FrameLayout {
     ...
     */
    private static boolean IS_ALLOW_CLOSE_ACTIVITY = true;
     ...
     */
    public static final int EDGE_LEFT = SwipeDragHelper.EDGE_LEFT;

    /**
     * Edge flag indicating that the right edge should be affected.
     */
    public static final int EDGE_RIGHT = SwipeDragHelper.EDGE_RIGHT;

    /**
     * Edge flag indicating that the bottom edge should be affected.
     */
    public static final int EDGE_BOTTOM = SwipeDragHelper.EDGE_BOTTOM;
     ...
     * fling/snap.
     */
    public static final int STATE_IDLE = SwipeDragHelper.STATE_IDLE;

    /**
     * A view is currently being dragged. The position is currently changing as
     * a result of user input or simulated user input.
     */
    public static final int STATE_DRAGGING = SwipeDragHelper.STATE_DRAGGING;

    /**
     * A view is currently settling into place as a result of a fling or
     * predefined non-interactive motion.
     */
    public static final int STATE_SETTLING = SwipeDragHelper.STATE_SETTLING;
    ...
    private SwipeDragHelper mDragHelper;
    ...
    public SwipeBackLayout(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs);
        mDragHelper = SwipeDragHelper.create(this, new ViewDragCallback());
    ...
    public void setIsAllowCloseActivity(boolean flag) {
        IS_ALLOW_CLOSE_ACTIVITY = flag;
    }

    /**
     * Enable edge tracking for the selected edges of the parent view. The
     * callback's
     * {@link me.imid.swipebacklayout.lib.SwipeDragHelper.Callback#onEdgeTouched(int, int)}
     * and
     * {@link me.imid.swipebacklayout.lib.SwipeDragHelper.Callback#onEdgeDragStarted(int, int)}
    ...
    public void setmAllowLeftFullScreen(boolean allow) {
        mDragHelper.setmAllowLeftFullScreen(allow);
    }
    ...
    protected boolean drawChild(Canvas canvas, View child, long drawingTime) {
        ...
        if (mScrimOpacity > 0 && drawContent
                && mDragHelper.getViewDragState() != SwipeDragHelper.STATE_IDLE) {
    ...
    private class ViewDragCallback extends SwipeDragHelper.Callback {
        ...
        public void onViewPositionChanged(View changedView, int left, int top, int dx, int dy) {
            ...
            if (mScrollPercent >= 1) {
                if (!mActivity.isFinishing() && IS_ALLOW_CLOSE_ACTIVITY) {
                    mActivity.finish();
                }
            }
        }
