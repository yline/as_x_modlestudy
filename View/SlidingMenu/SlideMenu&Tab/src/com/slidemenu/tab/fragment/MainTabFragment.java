...
public class MainTabFragment extends BaseFragment
{
    ...
    private void initTabLine()
    {
        ...
        android.view.ViewGroup.LayoutParams layoutParams = viewHolder.lineIv.getLayoutParams();
    ...
    private class tabsChangeClickListener implements View.OnClickListener
    {
        ...
        {
            if (getActivity() instanceof MainTabFragment.OnTabSelectedListener)
            {
                ((MainTabFragment.OnTabSelectedListener)getActivity()).onTabSelected((Integer)v.getTag());
            }
        }
    }
