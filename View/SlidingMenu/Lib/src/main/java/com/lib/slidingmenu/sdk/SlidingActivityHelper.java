package com.lib.slidingmenu.sdk;
...
import com.view.slidingmenu.lib.R;
...
public class SlidingActivityHelper
{
	...
	{
		mSlidingMenu = (SlidingMenu) LayoutInflater.from(mActivity).inflate(R.layout.lib_slidingmenu_main, null);
	}
