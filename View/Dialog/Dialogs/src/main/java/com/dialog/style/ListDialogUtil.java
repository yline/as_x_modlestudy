...
public class ListDialogUtil
{
	 ...
	 * @param title  title 标题
	 */
	public static void showDialogRadio(Context context, int iconId, String title, final String[] strs, final String oKText, final String cancelText)
	{
		choice = 1; // 默认选项
		AlertDialog.Builder dialog = new AlertDialog.Builder(context);
	 ...
	 * @param title  title 标题
	 */
	public static void showtDialogCheck(Context context, int iconId, String title, final String[] strs, final String oKText, final String cancelText)
	{
		multiChoiceId.clear();
		AlertDialog.Builder dialog = new AlertDialog.Builder(context);
		dialog.setIcon(iconId);
