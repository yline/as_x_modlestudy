...
public class CustomDialogUtil
{
	 ...
	 */
	@SuppressLint("InflateParams")
	public static void showDialogDesign(Context context, int iconId, String title, boolean cancelable, final String oKText, final String cancelText)
	{
		...
		{ // 确定按钮
			...
			public void onClick(DialogInterface dialog, int which)
			{
				...
				LogFileUtil.v(MainApplication.TAG, "showDialogDesign -> et_name = " + et_name.getText().toString().trim());
				LogFileUtil.v(MainApplication.TAG, "showDialogDesign -> et_password = " + et_password.getText().toString().trim());
			}
		});
