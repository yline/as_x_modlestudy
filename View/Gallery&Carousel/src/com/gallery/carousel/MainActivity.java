...
import yline.ui.carouselgallery.fragment.GalleryFragment;
import yline.ui.carouselgallery.fragment.GalleryFragmentParams;

/**
 * 这一块,需要修改的地方还挺多
 * @author YLine
 *
 * 2016年7月17日 下午7:56:22
 */
public class MainActivity extends BaseFragmentActivity implements GalleryFragment.OnCarouselGalleryItemClickListener
{
    ...
    private void initData()
    {
        ...
        params.setGalleryLayout(getScreenWidth(getApplicationContext()) - 40,
            getScreenWidth(getApplicationContext()) * 3 / 5);
