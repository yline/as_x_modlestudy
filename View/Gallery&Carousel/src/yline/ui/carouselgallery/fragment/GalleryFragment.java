package yline.ui.carouselgallery.fragment;

import com.gallery.carousel.R;
...
import yline.ui.carouselgallery.view.GalleryView;
import yline.ui.carouselgallery.view.GalleryView.GalleryState;
import yline.ui.carouselgallery.view.utils.UILayoutUtils;
...
public class GalleryFragment extends BaseFragment
{
    ...
    private void initData()
    {
        ...
        if (gallery.state == GalleryState.NORMAL)
        {
            // do nothing
        }
        else if (gallery.state == GalleryState.STACK)
        {
            gallery.setZoomUnit(params.getZoomUnit());
        }
        else if (gallery.state == GalleryState.ROTATEY)
        {
    ...
    private class GalleryBaseAdapter extends BaseAdapter
    {
        ...
        public View getView(int position, View convertView, ViewGroup parent)
        {
            ...
            convertView = params.getViewRes(getActivity(),
                position,
                convertView,
                R.layout.fragment_carousel_image,
                R.id.carousel_image_item);
    ...
    {
        android.widget.LinearLayout.LayoutParams linearParams = new android.widget.LinearLayout.LayoutParams(1, 1);
