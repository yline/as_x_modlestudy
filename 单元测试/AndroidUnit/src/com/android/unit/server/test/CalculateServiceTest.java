package com.android.unit.server.test;

import com.android.unit.server.CalculateService;
...
public class CalculateServiceTest extends ServiceTestCase<CalculateService>
{
        ...
        throws Exception
    {
        ...
        startService(new Intent(mContext, CalculateService.class).putExtra("param1", 2).putExtra("param2", 3));
