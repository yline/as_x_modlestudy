...
import com.data.network.https.R;
	...
	private void initData()
	{
		mBtnGetConnectionSubmit.setOnClickListener(new View.OnClickListener()
		{
			...
			public void onClick(View v)
			{
				...
				GetConnectionUtil.doHttpsLocal(ip, WEB_PROJECT_NAME, className, new GetConnectionUtil.GetConnectionCallback()
				{
		...
		mBtnPostConnectionSubmit.setOnClickListener(new View.OnClickListener()
		{
			...
			public void onClick(View v)
			{
				...
				PostConnectionUtil.doHttpsLocal(ip, WEB_PROJECT_NAME, className, new PostConnectionUtil.PostConnectionCallback()
				{
